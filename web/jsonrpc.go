...
//go:generate jsonrpc2-gen -i types.go -I TincWeb --js ui/src/api/index.js -p web -o jsonrpc.go -d ../API.md --url http://127.0.0.1:8686/api
package web

import (
	"encoding/json"
	jsonrpc2 "github.com/reddec/jsonrpc2"
	web "tinc-web-boot/web"
)

func RegisterTincWeb(router *jsonrpc2.Router, wrap web.TincWeb) []string {
	...
	return []string{"TincWeb.Networks", "TincWeb.Network", "TincWeb.Create", "TincWeb.Remove", "TincWeb.Start", "TincWeb.Stop", "TincWeb.Peers", "TincWeb.Peer"}
}
