...
//go:generate jsonrpc2-gen -i ../shared/types.go -I TincWeb --ts ../ui/src/api/api.ts -p internal -o jsonrpc.go -d ../../API.md --url http://127.0.0.1:8686/api
package internal
...
func RegisterTincWeb(router *jsonrpc2.Router, wrap shared.TincWeb) []string {
	...
	return []string{"TincWeb.Networks", "TincWeb.Network", "TincWeb.Create", "TincWeb.Remove", "TincWeb.Start", "TincWeb.Stop", "TincWeb.Peers", "TincWeb.Peer", "TincWeb.Import", "TincWeb.Share"}
}
