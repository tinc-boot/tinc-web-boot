...
//go:generate jsonrpc2-gen -i ../shared/types.go -I TincWeb --ts ../../api.ts -p internal -o jsonrpc.go --postman ../../postman.json ../../API.md -d ../../API.md --url http://127.0.0.1:8686/api
package internal
